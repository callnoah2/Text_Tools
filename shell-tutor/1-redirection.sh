...
_HELP="Shell Redirection
=================
* Redirect command output to a file
* Append output to a file
* What STDOUT and STDERR mean to your programs
* Printing text to STDOUT or STDERR in Python
* Hide unwanted command output
...
redir_stderr_nameerror_prologue() {
	...
	$(cmd '2>') redirects $(bld just) $(_STDERR standard error) to a file, leaving $(_STDOUT) to the
	terminal.
